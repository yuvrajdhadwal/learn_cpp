...
int main() {
    ...
    [[maybe_unused]] constexpr int classSize{
        bigClass ? 30 : 20};  // using ternarary operator to initialize
    ...
    // for bools != is same as logical xor (since xor is not a thing in cpp)
