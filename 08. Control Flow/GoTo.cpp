...
end_loop:
    ...
    // frankly, it would have been better to wrap those for loops in their own function and then
    // returned out and then have this endloop code in a wrapper function. that way we don't use
    // goto at all but this is techncialy, barely more performant
